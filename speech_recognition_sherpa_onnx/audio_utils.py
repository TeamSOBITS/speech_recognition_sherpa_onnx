...
class AudioCapture:
    def __init__(self, source_name, rate, channels, chunk_size, use_echo_cancel=False, echo_cancel_source=None):
        self.source = echo_cancel_source if use_echo_cancel else source_name
        self.rate = 16000 
        self.channels = 1 
